...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      // --- Custom Font Path (Korean fork) ---
      SettingInfo::String(StrId::STR_NONE_OPT, SETTINGS.customFontPath, sizeof(SETTINGS.customFontPath),
                          "customFontPath", StrId::STR_CAT_READER),
