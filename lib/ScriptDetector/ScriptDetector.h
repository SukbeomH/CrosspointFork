 ...
 *
 * Ported from Papyrix (bigbag/papyrix-reader) with Hangul-specific additions
 * for the Korean fork.
 */
...
enum class Script : uint8_t {
  ...
  HANGUL,  // Korean Hangul (subset of CJK for Korean-specific logic)
...
/**
 * Check if a codepoint is a CJK ideograph or related character.
...
/**
 * Check if a codepoint is Korean Hangul.
 *
 * Ranges:
 * - Hangul Syllables: U+AC00-U+D7AF
 * - Hangul Jamo: U+1100-U+11FF
